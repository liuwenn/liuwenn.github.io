$(document).ready(function () {
  ...
  $(".tab_title  li").on('click', function (ev) {
    ...
    $(".tab_titlecon>ul").eq(index).show().siblings('.tab_titlecon>ul').hide();
  ...
  function go() {
    Timer = setInterval(function () {
      ...
      $(".main_picright div").eq(iI).addClass('onborder').siblings('.main_picright div').removeClass('onborder');
  ...
  $(".con_cardone li").on('click', function () {
    ...
    $(".con_cardoul ul").eq(index6).show().siblings('.con_cardoul ul').hide();
  })
