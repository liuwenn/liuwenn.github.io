...
(function ($) {
	...
	$('head').append('<style>.fullcalendar-day {border-left: 1px solid #eee;border-top: 1px solid #eee;} '
		 ...
		 + '.fullcalendar-detail{border-radius:5px;position: absolute; z-index: 10; background-color: #E0366E; display: none; opacity: 0.8; padding: 5px; text-align: right;filter: Alpha(opacity=80);}'
